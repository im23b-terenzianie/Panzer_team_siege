...
public class Artillery implements BotInterface {
    ...
    public void start() {
        // GameWorld.startGame(this, Artillery.class); // This starts the game with a Artillery, and immediately starts the game when connected
        GameWorld.connectToServer(this, dev.zwazel.internal.game.tank.implemented.SelfPropelledArtillery.class); // This connects to the server with a Artillery, but does not immediately start the game
    }
